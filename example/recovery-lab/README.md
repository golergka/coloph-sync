...
| `deploy-tool` | Builder configuration is broken | Repair tooling and deploy HEAD. |
| `immutable-payload` | Service rejects committed release contents | Repair the payload and deploy HEAD. |
